...
public class BdActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      //  cursor.moveToFirst();
        ...
        String[] from = new String[] {DBHelper.date_, DBHelper.Chto_Kupil, DBHelper.summa_Pokup, DBHelper.rassrochka, DBHelper.rassrochka_ostalos};//берем этот набор данных
